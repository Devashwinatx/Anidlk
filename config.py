...
CRUNCHYROLL_USERNAME = os.getenv("CRUNCHYROLL_USERNAME", "v.entas3@softwareperuesd.com")  # Replace with your username
CRUNCHYROLL_PASSWORD = os.getenv("CRUNCHYROLL_PASSWORD", "@helber4292")  # Replace with your password
